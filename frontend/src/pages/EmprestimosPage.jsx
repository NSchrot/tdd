...
export function EmprestimosPage() {
  ...
  const livrosDisponiveis = livros.filter(l => {
    const marcadoDisponivel = l.disponivel === undefined || l.disponivel === true || Number(l.disponivel) > 0;
    return (marcadoDisponivel && !livrosEmprestados.has(l.id)) || (editando && l.id === editando.livro_id);
  });
