const { criarUsuario, listarUsuarios, buscarUsuarioPorId, buscarUsuarioPorEmail, loginUsuario, atualizarUsuario, deletarUsuario } = require("../services/usuarioService");
...
module.exports = { listar, buscarPorId, criar, login, atualizar, deletar };
